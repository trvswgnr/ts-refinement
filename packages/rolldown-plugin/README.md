...
Use `tspc --noEmit` for TypeScript 5.7 through 6.x CI diagnostics and `ts-refinement verify` from
`prepack`; this compatibility package only supplies the build transform.
